...
import { Button, EmptyState, ErrorBanner, Input, Label, Modal, Select, Spinner } from './ui'
...
/**
 * Shared master-catalog manager. Supplier contact details live here only —
 * project hardware rows read the email from the vendor's catalog entry.
 */
